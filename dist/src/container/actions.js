...
exports.onDragNode = function (_a) {
    ...
    return function (chart) {
        ...
        if (nodechart) {
            var chartToUpdate = __assign({}, nodechart, { position: config && config.snapToGrid
                    ? { x: Math.round(data.x / 20) * 20, y: Math.round(data.y / 20) * 20 }
                    : data });
            return __assign({}, chart, { nodes: __assign({}, chart.nodes, (_a = {}, _a[id] = chartToUpdate, _a)) });
        }
        return chart;
    };
};
exports.onDragCanvas = function (_a) {
    ...
    return function (chart) {
        return __assign({}, chart, { offset: config && config.snapToGrid
                ? { x: Math.round(data.x / 20) * 20, y: Math.round(data.y / 20) * 20 }
                : data });
    };
};
exports.onLinkStart = function (_a) {
    ...
    return function (chart) {
        var _a;
        return __assign({}, chart, { links: __assign({}, chart.links, (_a = {}, _a[linkId] = {
                id: linkId,
                from: {
                    nodeId: fromNodeId,
                    portId: fromPortId
...
exports.onLinkMove = function (_a) {
    ...
    return function (chart) {
        var _a;
        var linkToUpdate = chart.links[linkId];
        return __assign({}, chart, { links: __assign({}, chart.links, (_a = {}, _a[linkId] = __assign({}, linkToUpdate, { to: { position: toPosition } }), _a)) });
    };
};
exports.onLinkComplete = function (props) {
    ...
    return function (chart) {
        var _a;
        var links = __assign({}, chart.links);
        if ((config.validateLink ? config.validateLink(__assign({}, props, { chart: chart })) : true) && [fromNodeId, fromPortId].join() !== [toNodeId, toPortId].join()) {
            ...
            return __assign({}, chart, { links: __assign({}, links, (_a = {}, _a[linkId] = __assign({}, linkToUpdate, { to: { nodeId: toNodeId, portId: toPortId } }), _a)) });
        }
        delete links[linkId];
        return __assign({}, chart, { links: links });
    };
};
    ...
    return function (chart) {
        ...
        if (link.to.nodeId && link.to.portId) {
            if (chart.hovered.type !== 'link' || chart.hovered.id !== linkId) {
                return __assign({}, chart, { hovered: { type: "link", id: linkId } });
            }
        }
        return chart;
    };
...
exports.onLinkClick = function (_a) {
    ...
    return function (chart) {
        if (chart.selected.id !== linkId || chart.selected.type !== 'link') {
            return __assign({}, chart, { selected: { type: "link", id: linkId } });
        }
        return chart;
    };
};
...
exports.onDeleteKey = function () { return function (chart) {
    ...
    return __assign({}, chart, { nodes: nodes, links: links, selected: selected });
}; };
...
exports.onNodeSizeChange = function (_a) {
    ...
    return function (chart) {
        var _a;
        var nodeToUpdate = chart.nodes[nodeId];
        return __assign({}, chart, { nodes: __assign({}, chart.nodes, (_a = {}, _a[nodeId] = __assign({}, nodeToUpdate, { size: size }), _a)) });
    };
};
exports.onPortPositionChange = function (_a) {
    ...
    return function (chart) {
        ...
        if (nodeToUpdate.size) {
            ...
            var portToUpdate = node.ports[port.id];
            return __assign({}, chart, { nodes: __assign({}, chart.nodes, (_a = {}, _a[nodeToUpdate.id] = __assign({}, node, { ports: __assign({}, node.ports, (_b = {}, _b[port.id] = __assign({}, portToUpdate, { position: {
                            x: position.x,
                            y: position.y
                        } }), _b)) }), _a)) });
        }
...
exports.onCanvasDrop = function (_a) {
    ...
    return function (chart) {
        var _a;
        var id = uuid_1.v4();
        return __assign({}, chart, { nodes: __assign({}, chart.nodes, (_a = {}, _a[id] = {
                id: id,
